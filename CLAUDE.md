...
Follow strict vertical slice architecture with tests living next to the code they test. For example:
...
Use Google-style docstrings for all public functions, classes, and modules. For example:
